...
deliberately excluded: its model is mid-revision (see cost_model_status.md).
    ...
    python3 notes/report_tables.py             # all single-op sections
    python3 notes/report_tables.py --section 6 # one section
    python3 notes/report_tables.py --shapes 6  # + the per-shape table for that section
"""
